...
func newOperatorTestCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "authentication-operator-tests-ext",
		Short: "A binary used to run authentication-operator tests as part of OTE.",
...
func prepareOperatorTestsRegistry() *oteextension.Registry {
	...
	extension := oteextension.NewExtension("openshift", "payload", "authentication-operator")
