...
func (c *FakeAuthenticationV1alpha1) AuthenticationOperatorConfigs() v1alpha1.AuthenticationOperatorConfigInterface {
	return &FakeAuthenticationOperatorConfigs{c}
}
