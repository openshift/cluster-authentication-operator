...
func convertProviderConfigToOsinBytes(providerConfig *configv1.IdentityProviderConfig, syncData *idpSyncData, i int) ([]byte, error) {
	...
	case configv1.IdentityProviderTypeGitHub:
		...
		p = &osinv1.GitHubIdentityProvider{
			...
			ClientSecret:  createFileStringSource(syncData.AddSecret(i, githubConfig.ClientSecret, configv1.ClientSecretKey)),
	...
	case configv1.IdentityProviderTypeGitLab:
		...
		p = &osinv1.GitLabIdentityProvider{
			...
			ClientSecret: createFileStringSource(syncData.AddSecret(i, gitlabConfig.ClientSecret, configv1.ClientSecretKey)),
	...
	case configv1.IdentityProviderTypeGoogle:
		...
		p = &osinv1.GoogleIdentityProvider{
			...
			ClientSecret: createFileStringSource(syncData.AddSecret(i, googleConfig.ClientSecret, configv1.ClientSecretKey)),
	...
	case configv1.IdentityProviderTypeLDAP:
		...
		p = &osinv1.LDAPPasswordIdentityProvider{
			...
			BindPassword: createFileStringSource(syncData.AddSecret(i, ldapConfig.BindPassword, configv1.BindPasswordKey)),
	...
	case configv1.IdentityProviderTypeOpenID:
		...
		p = &osinv1.OpenIDIdentityProvider{
			...
			ClientSecret:             createFileStringSource(syncData.AddSecret(i, openIDConfig.ClientSecret, configv1.ClientSecretKey)),
