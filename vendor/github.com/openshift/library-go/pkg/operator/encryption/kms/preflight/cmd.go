...
func (o *options) addFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&o.configHash, "config-hash", "", "hash of config to use for encryption")
	fs.StringVar(&o.podName, "pod-name", "", "name of pod to use to report checker status")
	fs.StringVar(&o.podNamespace, "pod-namespace", "", "namespace of pod to report checker status")
