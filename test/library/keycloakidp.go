...
func (kc *KeycloakClient) CreateUser(username, email, password string, groups []string, otherKeycloakFields map[string]string) error {
	...
	for k, v := range otherKeycloakFields {
		user[k] = v
	}
