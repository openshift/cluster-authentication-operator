...
./authentication-operator-tests-ext run-suite openshift/authentication-operator/all
./authentication-operator-tests-ext run-test "test-name"

# Run with JUnit output
./authentication-operator-tests-ext run-suite openshift/authentication-operator/all --junit-path "${ARTIFACT_DIR}/junit.xml"
```
...
./authentication-operator-tests-ext list suites

# List tests in a suite
./authentication-operator-tests-ext list tests --suite=openshift/authentication-operator/all
```
