...
replace github.com/openshift/api => github.com/tchap/api v0.0.0-20260922110359-089a62adca7c

// branch: external-oidc-proxy
replace github.com/openshift/oauth-apiserver => github.com/tchap/oauth-apiserver v0.0.0-20260914151622-dec52228957c
